...
#veri almak okuma işlemleri

print(dosya.readline())#birinci satırı verir
print(dosya.readline())#ikinci satırı alır.alt lat ageldiği  için.
print(dosya.readline())#3 satırı  satırı alır.alt lat geldiği  için

#readlines metpdu
#butun satırları alır ve liste şeklinde veriri
